...
final class BD_WebNinja_Elementor_Extension {
	...
	public function init_widgets() {
		...
		require_once __DIR__ . '/widgets/Animation-Button/widget.php';
		Plugin::instance()->widgets_manager->register_widget_type( new Animation_Button_Widget() );
		// animated heading
		// require_once __DIR__ . '/widgets/Animated-heading/widget.php';
		// Plugin::instance()->widgets_manager->register_widget_type( new Animated_heading_Widget() );
		// timeline heading
		require_once __DIR__ . '/widgets/timeline/widget.php';
		Plugin::instance()->widgets_manager->register_widget_type( new Timeline_Widget() );
